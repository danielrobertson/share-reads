...
export const AppSidebar = ({ isOpen }: AppSidebarProps) => {
  ...
  if (!isOpen) {
    return (
      <div className="w-16 h-full bg-sidebar flex flex-col items-center py-4 border-r border-gray-800 transition-all duration-300">
  ...
  return (
    <div className="w-[232px] h-full bg-sidebar flex flex-col border-r border-gray-800 transition-all duration-300">
